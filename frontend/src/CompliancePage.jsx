...
const SUITE_OPTIONS = [
  ...
  { value: 'EH', label: 'Error Handling (EH)' },
  { value: 'PR', label: 'Performance & Reliability (PR)' },
];
...
const TC_OPTIONS_BY_SUITE = {
  DI: [
    ...
    { id: 'TC-DI-02', label: 'TC-DI-02 - Legibility (Unicode & Long Strings)' },
  ...
  EH: [
    { id: '', label: 'Run ALL Error Handling Compliance Tests' },
    { id: 'TC-EH-01-01', label: 'TC-EH-01-01 - Validation Error Message Security' },
    { id: 'TC-EH-01-02', label: 'TC-EH-01-02 - 404 Error Sanitization' },
    { id: 'TC-EH-02-01', label: 'TC-EH-02-01 - Network Timeout Data Preservation' },
    { id: 'TC-EH-03-01', label: 'TC-EH-03-01 - XSS Input Sanitization' },
    { id: 'TC-EH-03-02', label: 'TC-EH-03-02 - SQL Injection Input Sanitization' },
    { id: 'TC-EH-03-03', label: 'TC-EH-03-03 - Oversized Input Handling' },
    { id: 'TC-EH-04-01', label: 'TC-EH-04-01 - Server-Side Error Logging Context' },
    { id: 'TC-EH-05-01', label: 'TC-EH-05-01 - Executable Upload Rejection' },
    { id: 'TC-EH-05-02', label: 'TC-EH-05-02 - Oversized Upload Rejection' },
    { id: 'TC-EH-05-03', label: 'TC-EH-05-03 - Macro-Enabled Upload Rejection' },
    { id: 'TC-EH-06-01', label: 'TC-EH-06-01 - Deactivated Approver Workflow Halt' },
  ],
  AC: [
    { id: '', label: 'Run ALL Access Control Compliance Tests' },
    { id: 'TC-MR-AC01', label: 'TC-MR-AC01 - Create Viewer role for AC01 setup' },
    { id: 'TC-MU-AC01', label: 'TC-MU-AC01 - Create test Viewer user' },
    { id: 'TC-MSAC-AC01', label: 'TC-MSAC-AC01 - Set zero rights for Viewer role' },
    { id: 'TC-AC-01', label: 'TC-AC-01 - Deny Admin endpoint access for Viewer' },
    { id: 'TC-AC-02', label: 'TC-AC-02 - Deny Edit endpoint access for Viewer' },
    { id: 'TC-AC-03', label: 'TC-AC-03 - Deny Approve endpoint access for Viewer' },
    { id: 'TC-AC-MC-01', label: 'TC-AC-MC-01 - Deny Country module access for Viewer' },
    { id: 'TC-AC-MA-01', label: 'TC-AC-MA-01 - Deny Create APP access for Viewer' },
    { id: 'TC-MPP-AC02', label: 'TC-MPP-AC02 - Configure password policy prerequisite' },
    { id: 'TC-AC02-01', label: 'TC-AC02-01 - Reject short password on user create' },
    { id: 'TC-AC02-02', label: 'TC-AC02-02 - Reject password without uppercase' },
    { id: 'TC-AC02-03', label: 'TC-AC02-03 - Reject password without lowercase' },
    { id: 'TC-AC02-04', label: 'TC-AC02-04 - Reject password without numeric digit' },
    { id: 'TC-AC02-05', label: 'TC-AC02-05 - Reject password without special character' },
    { id: 'TC-AC02-PR-01', label: 'TC-AC02-PR-01 - Reset rejects short password' },
    { id: 'TC-AC02-PR-02', label: 'TC-AC02-PR-02 - Reset rejects no uppercase' },
    { id: 'TC-AC02-PR-03', label: 'TC-AC02-PR-03 - Reset rejects no lowercase' },
    { id: 'TC-AC02-PR-04', label: 'TC-AC02-PR-04 - Reset rejects no numeric' },
    { id: 'TC-AC02-PR-05', label: 'TC-AC02-PR-05 - Reset rejects no special character' },
    { id: 'TC-AC02-06', label: 'TC-AC02-06 - Accept compliant boundary password' },
    { id: 'TC-MPP-AC03', label: 'TC-MPP-AC03 - Configure session timeout prerequisite' },
    { id: 'TC-AC03-01', label: 'TC-AC03-01 - Auto logout after inactivity timeout' },
    { id: 'TC-AC03-02', label: 'TC-AC03-02 - Reject post-expiry action attempt' },
    { id: 'TC-AC03-03', label: 'TC-AC03-03 - Handle unsaved data on session expiry' },
    { id: 'TC-AC03-04', label: 'TC-AC03-04 - Re-authenticate after timeout' },
    { id: 'TC-AC03-05', label: 'TC-AC03-05 - Keep active session before timeout' },
    { id: 'TC-AC03-06', label: 'TC-AC03-06 - Enforce changed timeout value' },
    { id: 'TC-MPP-AC04', label: 'TC-MPP-AC04 - Configure MFA prerequisite' },
    { id: 'TC-AC04-01', label: 'TC-AC04-01 - Block login bypass without MFA' },
    { id: 'TC-AC04-02', label: 'TC-AC04-02 - Block approval without MFA' },
    { id: 'TC-AC04-03', label: 'TC-AC04-03 - Positive login and approval with MFA' },
    { id: 'TC-AC04-GxP-01', label: 'TC-AC04-GxP-01 - Block GxP form approval without MFA' },
    { id: 'TC-AC04-GxP-02', label: 'TC-AC04-GxP-02 - Block GxP master approval without MFA' },
    { id: 'TC-AC04-04', label: 'TC-AC04-04 - Positive GxP approval with MFA' },
    { id: 'TC-MPP-AC05', label: 'TC-MPP-AC05 - Configure lockout threshold prerequisite' },
    { id: 'TC-AC05-01', label: 'TC-AC05-01 - Lock account at failed login threshold' },
    { id: 'TC-AC05-02', label: 'TC-AC05-02 - Keep locked account blocked' },
    { id: 'TC-AC05-03', label: 'TC-AC05-03 - Log failed attempts in audit' },
    { id: 'TC-AC05-04', label: 'TC-AC05-04 - Unlock restores user login' },
    { id: 'TC-AC05-PR-01', label: 'TC-AC05-PR-01 - Block reset on locked account' },
    { id: 'TC-AC05-PR-02', label: 'TC-AC05-PR-02 - eSign failure lockout behavior' },
    { id: 'TC-AC05-05', label: 'TC-AC05-05 - Unlock and reset recovery' },
    { id: 'TC-MR-AC06', label: 'TC-MR-AC06 - Create role for AC06 setup' },
    { id: 'TC-MU-AC06', label: 'TC-MU-AC06 - Create user for AC06 setup' },
    { id: 'TC-MSAC-AC06', label: 'TC-MSAC-AC06 - Set role rights for AC06 setup' },
    { id: 'TC-AC06-01', label: 'TC-AC06-01 - Audit role assignment' },
    { id: 'TC-AC06-02', label: 'TC-AC06-02 - Audit role revocation' },
    { id: 'TC-AC06-03', label: 'TC-AC06-03 - Audit permission change' },
    { id: 'TC-AC06-04', label: 'TC-AC06-04 - Audit role rename propagation' },
    { id: 'TC-AC06-05', label: 'TC-AC06-05 - Audit required fields completeness' },
    { id: 'TC-AC08-01', label: 'TC-AC08-01 - API rejects request without token' },
    { id: 'TC-AC08-02', label: 'TC-AC08-02 - API rejects expired token' },
    { id: 'TC-AC08-03', label: 'TC-AC08-03 - API allows valid token/session' },
    { id: 'TC-AC08-04', label: 'TC-AC08-04 - API endpoint guessability protection' },
    { id: 'TC-MU-AC09', label: 'TC-MU-AC09 - Create deactivation test user' },
    { id: 'TC-AC09-01', label: 'TC-AC09-01 - Deactivation blocks login' },
    { id: 'TC-AC09-02', label: 'TC-AC09-02 - Preserve historical records post deactivation' },
    { id: 'TC-AC09-03', label: 'TC-AC09-03 - Block deactivated user interactions' },
    { id: 'TC-AC09-04', label: 'TC-AC09-04 - Reactivation restores access' },
    { id: 'TC-AC09-05', label: 'TC-AC09-05 - Prevent duplicate active username' },
    { id: 'TC-AC09-06', label: 'TC-AC09-06 - Allow username reuse after deactivation' },
    { id: 'TC-AC10-01', label: 'TC-AC10-01 - Deny builder access for standard users' },
    { id: 'TC-AC10-02', label: 'TC-AC10-02 - Allow builder access for admin users' },
    { id: 'TC-AC10-03', label: 'TC-AC10-03 - Restrict builder in QA environment' },
    { id: 'TC-AC10-04', label: 'TC-AC10-04 - Restrict builder in Production environment' },
    { id: 'TC-VMS-AC10-01', label: 'TC-VMS-AC10-01 - Dev initial template versioning' },
    { id: 'TC-VMS-AC10-02', label: 'TC-VMS-AC10-02 - Dev to QA promotion and rejection' },
    { id: 'TC-VMS-AC10-03', label: 'TC-VMS-AC10-03 - Dev failure successor versioning' },
    { id: 'TC-VMS-AC10-04', label: 'TC-VMS-AC10-04 - Dev success promotion to QA' },
    { id: 'TC-VMS-AC10-05', label: 'TC-VMS-AC10-05 - QA to Production promotion' },
    { id: 'TC-VMS-AC10-06', label: 'TC-VMS-AC10-06 - Full Dev-QA-Prod lifecycle validation' },
  ],
  PR: [
    { id: '', label: 'Run ALL Performance and Reliability Compliance Tests' },
    { id: 'TC-PR-01-01', label: 'TC-PR-01-01 - Entry Dashboard/Form Issuance p95 <= 3s @ 50 users' },
    { id: 'TC-PR-01-02', label: 'TC-PR-01-02 - Admin list pages p95 <= 3s @ 50 users' },
    { id: 'TC-PR-02-01', label: 'TC-PR-02-01 - Approval actions p95 <= 5s @ 50 concurrent users' },
    { id: 'TC-PR-03-01', label: 'TC-PR-03-01 - 100-user stress stability (30 minutes)' },
    { id: 'TC-PR-04-01', label: 'TC-PR-04-01 - Bulk import 1000 records <= 10 minutes' },
    { id: 'TC-PR-05-01', label: 'TC-PR-05-01 - 99.5% monthly uptime SLA evidence review' },
    { id: 'TC-PR-06-01', label: 'TC-PR-06-01 - Audit export 10000+ records within SLA' },
  ],
};
...
const SUITE_META = {
  ...
  EH: {
    title: 'Error Handling Compliance Suite',
    label: 'Error Handling (EH)',
    displayName: 'Error Handling',
  },
  AC: {
    title: 'Access Control Compliance Suite',
    label: 'Access Control (AC)',
    displayName: 'Access Control',
  },
  PR: {
    title: 'Performance and Reliability Compliance Suite',
    label: 'Performance & Reliability (PR)',
